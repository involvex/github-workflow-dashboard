...
const COLORS: Record<StatusKey, StatusColor> = {
  ...
  completed_cancelled: {
    ...
    bgClass:
      "bg-gradient-to-br from-gray-500 to-slate-600 dark:from-gray-600 dark:to-slate-700",
  ...
  completed_skipped: {
    ...
    bgClass:
      "bg-gradient-to-br from-purple-500 to-violet-600 dark:from-purple-600 dark:to-violet-700",
  ...
  completed_stale: {
    ...
    bgClass:
      "bg-gradient-to-br from-stone-500 to-gray-600 dark:from-stone-600 dark:to-gray-700",
  ...
  other: {
    ...
    bgClass:
      "bg-gradient-to-br from-slate-500 to-gray-600 dark:from-slate-600 dark:to-gray-700",
...
export function getStatusColor(
  ...
  if (status === "completed") {
    switch ((conclusion || "").toLowerCase()) {
      case "success":
        return COLORS.completed_success;
      case "failure":
        return COLORS.completed_failure;
      case "cancelled":
        return COLORS.completed_cancelled;
      case "skipped":
        return COLORS.completed_skipped;
      case "neutral":
        return COLORS.completed_neutral;
      case "timed_out":
        return COLORS.completed_timed_out;
      case "stale":
        return COLORS.completed_stale;
      default:
        return COLORS.other;
    }
  }
